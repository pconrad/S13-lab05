package edu.ucsb.cs56.S13.drawings.fannykuang.simple;
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       // Fanny finished adding the top circle
       ...
       // Fanny added her signature
       
       g2.drawString("A house and a snowman, by Phill Conrad", 20,20);
       g2.drawString("Fanny Kuang added the snowman's head", 20,40);
    }
