package edu.ucsb.cs56.S13.drawings.spencerpao.simple;
...
/**
   ...
   @author Spencer Pao (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManTopCircle = 
           ...
           (
             snowManCenterBottomX,
             snowManCenterBottomY - bottomRadius * 2 - topRadius - middleRadius * 2,
             topRadius
	    );
       ...
       g2.drawString("Top of snowman added by Spencer Pao", 20,40);
    }
