...
public class AllMyDrawings
{
	...
	Ghost ghost1 = new Ghost(100,250,50,50);
	g2.setColor(Color.CYAN); g2.draw(ghost1);
	
	// Make a black ghost that's half the size, 
	// and moved over 150 pixels in x direction

	Shape ghost2 = ShapeTransforms.scaledCopyOfLL(ghost1,0.5,0.5);
	...
	g2.drawString("A few ghosts by Dario Castellanos", 20,20);
    }
