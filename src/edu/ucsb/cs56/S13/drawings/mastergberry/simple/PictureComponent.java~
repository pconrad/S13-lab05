package edu.ucsb.cs56.S13.drawings.mastergberry.simple;
...
/**
   ...
   @author Adam Ehrlich (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Adam Ehrlich", 20,40);
    }
