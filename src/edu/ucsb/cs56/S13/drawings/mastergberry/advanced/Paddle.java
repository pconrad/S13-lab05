...
public class Paddle extends GeneralPathWrapper implements Shape
{
    ...
    {
		double upperLeftY = paddleDiameter + stickHeight;
		double upperLeftX = paddleDiameter;
		Ellipse2D.Double paddleCircle = new Ellipse2D.Double(upperLeftX, upperLeftY, paddleDiameter/2, paddleDiameter/2);
		Rectangle2D.Double stick = new Rectangle2D.Double(upperLeftX + paddleDiameter/4 - stickWidth/2, upperLeftY + paddleDiameter/2, stickWidth, stickHeight);
