package edu.ucsb.cs56.S13.drawings.gordoncheung.simple;
...
/**
   ...
   @author Gordon Cheung (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Gordon Cheung", 20,40);
    }
