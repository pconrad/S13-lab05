package edu.ucsb.cs56.S13.drawings.jdmoody.simple;
...
/**
   ...
   @author Jonathan Moody (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Jonathan Moody", 20,40);
    }
